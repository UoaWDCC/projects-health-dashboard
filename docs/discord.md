...
The Discord ingestion requires a Discord application with a bot user in order to read messages from the server. The following shows tep-by-step instructions for setting one up and integrating it within the codebase.
