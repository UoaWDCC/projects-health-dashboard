  ...
  return (
    ...
    <div className="px-5 sm:px-10 lg:px-[max(0px,calc(136px_-_5vw))] pt-6 sm:pt-8 relative w-full lg:min-h-[calc(100dvh-4rem)] lg:flex lg:flex-col lg:justify-center lg:py-0">
      <div className="w-full lg:max-w-[1292px] lg:mx-auto">
        ...
        {/* Main Headings*/}
        <div className="flex items-end justify-between mt-6 sm:mt-10 lg:mt-14">
          <div className="flex flex-col justify-between">
            <div>
              ...
              {/* Subheading */}
              <div className="mt-4 sm:mt-6 lg:mt-8 max-w-[54.1875rem]">
                <h3 className="text-wdcc-grey font-medium text-[clamp(0.81rem,1.4vw+0.6vh,1.25rem)] leading-relaxed m-0">
                  Track commits, team vibes, and health scores across all WDCC projects — live and
                  at a glance.
                </h3>
              </div>
            </div>
